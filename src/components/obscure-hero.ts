            ...
            <section class="hero container">
                <div class="hero-title" data-text="OBSCURE COMPUTER">
                    <div class="hero-title-text">
                        <span class="hero-text-animation">OBSCURE</span>
                    </div>
                    <h1 class="hero-title-text">
                        <span
                            class="hero-text-animation"
                ...
                <div class="hero-sub">
                    <div>
                        <span class="hero-dot-thingy"></span>EST. BARELY 2025
                    </div>
                    <div>
                        <span class="hero-dot-thingy"></span>WE MAKE OBSCURE
                        STUFF
                    </div>
                </div>
